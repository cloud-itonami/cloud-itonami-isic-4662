...
(deftest delivery-dispatch-never-auto-at-any-phase
  (testing "structural invariant: no phase, now or in any future entry, auto-commits a real bulk-metal/ore dispatch"
...
(deftest invoice-settle-never-auto-at-any-phase
  (testing "structural invariant: no phase, now or in any future entry, auto-commits a real metal invoice settlement"
    (doseq [[n {:keys [auto]}] phase/phases]

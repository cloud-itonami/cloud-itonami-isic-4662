# Operator Quickstart — Wholesale of metals and metal ores

Shortest path from clone to a verified local dry-run for **ISIC 4662** (`cloud-itonami-isic-4662`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-4662.git
cd cloud-itonami-isic-4662
```
...
- Blueprint governor key: `metal-trading-governor`
- Likely source path: `metaltrade.governor.cljc`
